...
MCPhylo.force_ultrametric!(d)
MCPhylo.gradlogpdf(bd, d)

f1 = MCPhylo.Fossil(["Dra.SOUTHERN_DRAVIDIAN.TODA","Dra.SOUTHERN_DRAVIDIAN.MALAYALAM"], 0.3, 0.3, false)
f2 = MCPhylo.Fossil(["Dra.SOUTHERN_DRAVIDIAN.TODA","Dra.SOUTHERN_DRAVIDIAN.MALAYALAM"], 0.2, 0.5, true)
f3 = MCPhylo.Fossil(["Dra.SOUTHERN_DRAVIDIAN.KURUMBA_ALU","Dra.SOUTHERN_DRAVIDIAN.ULLATAN"], 0.4, 0.4, false)
f4 = MCPhylo.Fossil(["Dra.SOUTHERN_DRAVIDIAN.IRULA","Dra.SOUTHERN_DRAVIDIAN.RAVULA"], 0.6, 0.8, true)
fbd = MCPhylo.FossilizedBirthDeath(0.2, 0.23, 0.48, 0.3, [f1,f2,f3,f4])
MCPhylo.gradlogpdf(fbd, d)
