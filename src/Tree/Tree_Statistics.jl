...
channels (where the generated trees will be stored) and the total number of
trees in each chain as arguments. The default minimal splits threshold is 0.1.
"""
function ASDSF(r_channels::Vector{RemoteChannel}, n_trees::Int64,
               min_splits::Float64)::Vector{Float64}
...
function asdsf_int_channel(splitsQueue, splitsQueues, ASDF_vals, min_splits, r_channels)::Vector{Float64}
